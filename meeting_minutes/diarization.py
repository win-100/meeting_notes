...
def diarize(path, num_speakers=None):
    """Diarize a WAV file with pyannote Community-1.

    The waveform is loaded explicitly so the pipeline does not use TorchCodec.
    """
    ...
    try:
        ...
        return [
            DiarizationSegment(turn.start, turn.end, speaker)
